...
class SortDataTest < Minitest::Spec
  ...
  describe 'brands_2' do
    it '.sort' do
      ...
      assert_equal(result, ["SOUND OF LIGHT", "THE SCHOOL OF LIFE", "S. OLIVER", "THE SCHOOL OF LIFE PRESS", "THE STATIONERY OFFICE LTD", "SOPA DE LETRAS", "SOCIETY OF BIBLICAL LITERATURE", "SOCCER BOOKS LTD", "Sophie La Girafe", "SOUND VOLUMES LLC"])
    end
  end
end
